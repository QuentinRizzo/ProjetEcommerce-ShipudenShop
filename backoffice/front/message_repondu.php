                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <form action="../controler/traitement_message_supprimer.php" method="post" onsubmit="return confirm('Voulez-vous vraiment Archiver le message ?');">
                                                ...
                                                <form action="../controler/traitement_message_archiver.php" method="post" onsubmit="return confirm('Voulez-vous vraiment Archiver le message ?');">
                                                    <input type="hidden" name="id_messages" value="<?php echo $msg['id_messages']; ?>">
                                                    <input type="hidden" name="action" value="archiverMessage">
                                                    <button type="submit" class="btn btn-primary btn-sm me-1" data-mdb-toggle="tooltip" title="Archiver le Message">
                                                ...
                                                <form action="../public/index.php?page=19" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-secondary btn-sm" title="Afficher le Message">
