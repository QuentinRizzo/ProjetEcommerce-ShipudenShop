                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                <form action="../controler/traitement_delete_messagedef.php" method="post" onsubmit="return confirm('Voulez-vous vraiment Supprimer le message ?');">
                                                    <input type="hidden" name="id_messages" value="<?php echo $msg['id_messages']; ?>">
                                                    <input type="hidden" name="action" value="supprimerMessage">
                                                    <button type="submit" class="btn btn-danger btn-sm me-1" data-mdb-toggle="tooltip" title="Effacer le message">
                                                ...
                                                <form action="../controler/traitement_restaurer_msg.php" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-success btn-sm me-1" title="Restaurer le Message">
