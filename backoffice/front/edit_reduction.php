...
$id_bon = $_POST['id_bon'];
$recupReduction = recupBonReductionId($pdo, $id_bon);
...
<div class="container-fluid">
    <div class="form h-100 feuille-contact mt-5 p-4">
        ...
        ?>
        <h1 class="text-center mb-5 mt-5">Editer une Reduction</h1>
        <form class="mb-5" method="post" action="../controler/traitement_update_reduction.php" enctype="multipart/form-data">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 form-group mb-3">
                    ...
                    <input type="number" class="form-control" name="nbArticle" min="0" id="nbArticle" value="<?php echo $recupReduction['nb_articles_min'] ?>">
                </div>
                <div class="col-md-6 form-group mb-3">
                <label for="tauxReduction" class="col-form-label">Taux de Réduction :</label>
                <input type="text" class="form-control" name="tauxReduction" value="<?php echo $recupReduction['taux'] ?>">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-12 form-group mb-3 d-flex align-items-center justify-content-center">
                    <form action="../controler/traitement_update_reduction.php" method="post" class="col-md-12 form-group text-center mt-5">
                        <input type="hidden" name="id_bon" value="<?php echo $recupReduction['id_bon'] ?>">
                        <input type="submit" value="Ajouter" class="btn-card text-center w-25" name="update-bon">
