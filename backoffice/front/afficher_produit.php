...
<div class="row mx-auto mt-1 d-flex mx-auto">
    <div class="col-lg-5 mx-auto">
        ...
        <img src="../../public/ressource/figurines/<?php echo $recupProduit['logo'] ?>" class="d-block w-80 mt-5 mb-3 img-fluid image-card-equipe" alt="<?php echo $recupProduit['titre'] ?>">
    </div>
